...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var uncheckedBorderColor: UIColor = #colorLiteral(red: 0.3725490196, green: 0.2241211534, blue: 0.07393562049, alpha: 1)
    
    @IBInspectable
    var checkedBorderColor: UIColor = #colorLiteral(red: 0.3725490196, green: 0.2241211534, blue: 0.07393562049, alpha: 1)
    
    @IBInspectable
    var checkmarkColor: UIColor = #colorLiteral(red: 0.3725490196, green: 0.2241211534, blue: 0.07393562049, alpha: 1)
